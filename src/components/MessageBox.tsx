...
const MessageBox = ({
  ...
  const showPostResponseContent = !(isLast && loading);
    ...
    <div className="space-y-6">
      <div className={'w-full pt-8 break-words'}>
        <div className={'flex justify-end w-full'}>
          <h2 className="text-black dark:text-white font-medium text-xl text-left lg:w-9/12">
        ...
        <div className="flex flex-col space-y-2">
          ...
          {section.assistantMessage && (
            <>
              ...
              {showPostResponseContent &&
                section.sourceMessage &&
                section.sourceMessage.sources.length > 0 && (
                  <div className="flex flex-col space-y-2 pt-4 border-t border-light-200/40 dark:border-dark-200/40">
                    <div className="flex flex-row items-center space-x-2">
              ...
              {showPostResponseContent && (
                <div className="flex flex-col lg:flex-row items-stretch gap-3 pt-4">
                  <SearchImages
